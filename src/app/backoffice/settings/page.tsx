...
import { ThemeSettings } from "@/components/backoffice/settings/ThemeSettings";
import { InterfaceSettings } from "@/components/backoffice/settings/InterfaceSettings";
import { NotificationSettings } from "@/components/backoffice/settings/NotificationSettings";
import { useUserSettingsStore } from "@/store/backoffice/userSettingsStore";
...
export default function SettingsPage() {
  ...
  const { setSidebarCollapsed: setCollapsed } = useBackofficeSidebarStore();
